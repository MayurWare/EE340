...
class part1a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Q1 a")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Q1 a")
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(0.9)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(amplitude/(0.025))
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'E:\\5. AUTUMN 2021\\EE340\\Lab 5\\Input.bin', True, 0, 0)
    ...
    def set_amplitude(self, amplitude):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.amplitude/(0.025))
