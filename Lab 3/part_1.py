...
class part_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iir_filter_xxx_0 = filter.iir_filter_ffd([0,0.0000226757], [1,1], True)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.rational_resampler_xxx_0_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.blocks_multiply_xx_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 12000, 1000, firdes.WIN_HAMMING, 6.76))
