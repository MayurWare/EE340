...
class q2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Q1B")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Q1B")
        ...
        self.settings = Qt.QSettings("GNU Radio", "q2")
        ...
        # Variables
        ##################################################
        self.samp_rate1 = samp_rate1 = 3528000
        ...
        self.rational_resampler_xxx_0_0 = filter.rational_resampler_fff(
                interpolation=samp_rate,
                decimation=samp_rate1,
                taps=None,
                fractional_bw=None)
        self.rational_resampler_xxx_0 = filter.rational_resampler_fff(
                interpolation=samp_rate1,
        ...
        self.qtgui_tab_widget_0.addTab(self.qtgui_tab_widget_0_widget_0, 'Message Signal')
        ...
        self.qtgui_tab_widget_0.addTab(self.qtgui_tab_widget_0_widget_1, 'Modulated Signal')
        ...
        self.qtgui_tab_widget_0.addTab(self.qtgui_tab_widget_0_widget_2, 'Demodulated Signal')
        ...
        self.top_grid_layout.addWidget(self._qtgui_sink_x_2_win)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iir_filter_xxx_0_0_0 = filter.iir_filter_ffd([1,-0.95], [1], True)
        self.iir_filter_xxx_0_0 = filter.iir_filter_ffd([1,-0.95], [1], False)
        self.iir_filter_xxx_0 = filter.iir_filter_ffd([0,1/samp_rate], [1,1], True)
        self.dc_blocker_xx_0 = filter.dc_blocker_ff(20000, True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('E:\\5. AUTUMN 2021\\EE340\\Lab 3\\music.wav', False)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('E:\\5. AUTUMN 2021\\EE340\\Lab 3\\abc.wav', 1, samp_rate, 16)
        self.blocks_throttle_0_0_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_throttle_0_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate1,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vcc(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(100)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(1/6.28)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'E:\\5. AUTUMN 2021\\EE340\\Lab 3\\task1.dat', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 1)
        self.blocks_conjugate_cc_0 = blocks.conjugate_cc()
        self.blocks_complex_to_arg_0 = blocks.complex_to_arg(1)
        self.analog_sig_source_x_2 = analog.sig_source_c(samp_rate1, analog.GR_COS_WAVE, 100000, 2, 0, 0)
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(471230)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_sink_x_2, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.qtgui_sink_x_1, 0))
        self.connect((self.blocks_throttle_0_0_0, 0), (self.qtgui_sink_x_0, 0))
        ...
        self.connect((self.iir_filter_xxx_0_0, 0), (self.blocks_throttle_0_0_0, 0))
        self.connect((self.iir_filter_xxx_0_0, 0), (self.iir_filter_xxx_0, 0))
        self.connect((self.iir_filter_xxx_0_0_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.iir_filter_xxx_0_0, 0))
    ...
    def set_samp_rate1(self, samp_rate1):
        ...
        self.analog_sig_source_x_2.set_sampling_freq(self.samp_rate1)
        self.blocks_throttle_0_0.set_sample_rate(self.samp_rate1)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate1, 16000, 1000, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iir_filter_xxx_0.set_taps([0,1/self.samp_rate], [1,1])
...
def main(top_block_cls=q2, options=None):
