...
class q1a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "q1a")
        ...
        # Variables
        ##################################################
        self.samp_rate1 = samp_rate1 = 5000000
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iir_filter_xxx_0_0_0 = filter.iir_filter_ffd([1,-0.95], [1], False)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1100, 0.5, 0, 0)
    ...
    def set_samp_rate1(self, samp_rate1):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate1, 12000, 1000, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=q1a, options=None):
