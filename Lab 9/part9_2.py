...
class part9_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 9 Part 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 9 Part 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "part9_2")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'E:\\5. AUTUMN 2021\\EE340\\Lab 9\\Original_Text.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'E:\\5. AUTUMN 2021\\EE340\\Lab 9\\Lab9Part2.txt', False)
...
def main(top_block_cls=part9_2, options=None):
