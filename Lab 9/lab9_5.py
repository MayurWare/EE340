...
class lab9_5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab9_Part5")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab9_Part5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab9_5")
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc([sqrt(2), 1+1j, sqrt(2)*1j, -1+1j, -sqrt(2), -1-1j, -sqrt(2)*1j, 1-1j], 1)
        ...
        self.blocks_throttle_1 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate/4,True)
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.blocks_throttle_1, 0))
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0_0, 0), (self.blocks_throttle_1_0, 0))
...
def main(top_block_cls=lab9_5, options=None):
