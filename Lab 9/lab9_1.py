...
class lab9_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab 9 Part 1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 9 Part 1")
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, 45)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'E:\\5. AUTUMN 2021\\EE340\\Lab 9\\Lab9Part1.txt', False)
