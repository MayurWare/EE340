...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.SampleRate = SampleRate = 960000
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(SampleRate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(SampleRate, analog.GR_COS_WAVE, 10000, 1, 0, 0)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_2, 1))
    ...
    def set_SampleRate(self, SampleRate):
        ...
        self.analog_sig_source_x_1.set_sampling_freq(self.SampleRate)
        self.blocks_throttle_0.set_sample_rate(self.SampleRate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.SampleRate, , , firdes.WIN_HAMMING, 6.76))
