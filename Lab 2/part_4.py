...
class part_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Part 4")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Part 4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "part_4")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'E:\\5. AUTUMN 2021\\EE340\\Lab 2\\lab2_task4.dat', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(3, self.samp_rate, 15000, 5000, firdes.WIN_HAMMING, 6.76))





def main(top_block_cls=part_4, options=None):
