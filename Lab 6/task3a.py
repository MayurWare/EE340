...
class task3a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Q3a")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Q3a")
        ...
        self.settings = Qt.QSettings("GNU Radio", "task3a")
...
def main(top_block_cls=task3a, options=None):
