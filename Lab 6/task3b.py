...
class task3b(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Q3b")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Q3b")
        ...
        self.settings = Qt.QSettings("GNU Radio", "task3b")
        ...
        self.tab_widget.addTab(self.tab_widget_widget_1, 'Before CMA')
        ...
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(16, 4, 1e-2, 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'E:\\5. AUTUMN 2021\\EE340\\Lab 6\\input2.bin', True, 0, 0)
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.digital_fll_band_edge_cc_0, 0))
        ...
        self.connect((self.digital_cma_equalizer_cc_0, 0), (self.analog_agc_xx_0, 0))
...
def main(top_block_cls=task3b, options=None):
