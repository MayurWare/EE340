...
class part2_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Q2 and Q3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Q2 and Q3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "part2_3")
...
def main(top_block_cls=part2_3, options=None):
