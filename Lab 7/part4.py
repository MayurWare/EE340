...
class part4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Q4")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Q4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "part4")
        ...
        self._gain_range = Range(0, 1, 0.001, 1, 200)
        ...
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(4, 1, gain, 8)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.digital_cma_equalizer_cc_0, 0))
    ...
    def set_nfilts(self, nfilts):
        ...
        self.set_ntaps(11*self.nfilts*self.sps)
        self.set_rx_taps(firdes.root_raised_cosine(self.nfilts,self.nfilts*self.sps,1.0,0.4,self.ntaps))
        self.set_tx_taps(firdes.root_raised_cosine(self.nfilts,self.nfilts,1.0,0.4,self.ntaps))
...
def main(top_block_cls=part4, options=None):
